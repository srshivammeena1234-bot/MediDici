...
export const StethoscopeIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4.8 2.3A.3.3 0 1 0 5 2a.3.3 0 0 0-.2.3" /><path d="M6.4 4a.3.3 0 1 0 .4.3.3.3 0 0 0-.4-.3" />
    <path d="M13 3.3c-2.8-.6-5.5.3-7.6 2.4C3.3 7.8 2.4 10.5 3 13.3" /><path d="M19.8 8.2a.3.3 0 1 0 .4-.3.3.3 0 0 0-.4.3" />
    <path d="M18.2 10a.3.3 0 1 0 .4.3.3.3 0 0 0-.4-.3" /><path d="M11 20.7c2.8.6 5.5-.3 7.6-2.4C20.7 16.2 21.6 13.5 21 10.7" />
    <path d="M12 15a3 3 0 0 0-3 3v2" /><circle cx="12" cy="12" r="10" />
  </svg>
);
